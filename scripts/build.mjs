...
function page(route,title,body,summary,scripts=[]){
 ...
 if(illustrated)raw=raw.replace('</head>','<link rel="stylesheet" href="/assets/living-worlds.css"></head>');
...
page('/pricing/','Free vs Plus',pricingPage(themes,config),`ChatDrobe Plus is $${config.plusAnnualUsd}/year. Compare static themes, Living Worlds and local tools. Checkout is not enabled yet.`);
