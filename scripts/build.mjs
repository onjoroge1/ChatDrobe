...
page('/living-worlds/','Living Worlds concept showcase',livingWorldsShowcase(),'Interact with next-generation ChatDrobe concepts including moving journeys, atmosphere, day and night, Portal Mode and session-responsive worlds.',['living-worlds.js']);
...
write('build-manifest.json',JSON.stringify({websiteVersion:'0.5.0',extensionVersion:config.extensionVersion,routes,themes:themes.length},null,2)+'\n');
