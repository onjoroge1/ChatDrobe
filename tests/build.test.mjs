...
test('catalog preserves 12 unique worlds and 8 proposed free themes',()=>{assert.equal(themes.length,12);assert.equal(new Set(themes.map(t=>t.id)).size,12);assert.equal(themes.filter(t=>t.plan==='free').length,8);});
