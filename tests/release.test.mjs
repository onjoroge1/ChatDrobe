...
test('core assets retain their budget and showcase CSS loads only on the showcase route',()=>{
 ...
 assert.ok(sceneCss>0&&sceneCss<12000,`Optional showcase CSS must remain under 12 KB: ${sceneCss}`);
 for(const route of pages){
  ...
  assert.equal(styles.includes('/assets/living-worlds.css'),route==='/living-worlds/',route);
