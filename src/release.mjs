...
const summaries={
 '/':'Original cat, mecha and comic themes for your ChatGPT workspace. Preview 12 worlds, explore local tools and try the desktop Chrome private beta.',
 '/themes/':'Browse 12 original ChatDrobe worlds. Search, filter light and dark palettes, save local favorites and download appearance settings.',
 ...
 '/pricing/':'Compare proposed ChatDrobe Free and Plus plans. All 12 worlds are unlocked in the beta; checkout and paid subscriptions are not active.',
